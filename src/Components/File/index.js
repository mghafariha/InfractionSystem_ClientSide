    ...
    onDeleteClick=(file)=>{
          ...
          //  e.preventDefault();
            ...
            deleteFile(file.path).then( d=>{
             this.setState({filesShow:this.state.filesShow.filter(a=>a.FileName!=file.FileName),files:this.state.files.replace(file.path+"|",'')})
                ...
                <ul>
                    {
                     this.state.filesShow.map((file,index)=><div key={index}>
                                                     ...
                                                     {/* <input type='button' onClick={event => this.onDeleteClick(file)} className='close-btt' value='حذف'/> */}
                                                     <span  onClick={event => this.onDeleteClick(file)} className='close-btt'>✖</span>
                                                     </div>)

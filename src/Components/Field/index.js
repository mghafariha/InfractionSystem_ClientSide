...
class Field extends React.Component{
   ...
   render() {
    ...
    let { accessor, type ,Options, Header,errorMessge,isDisabled,path,step,IsMulti } = this.props
     let value=this.props.item[accessor]||null;
   // console.log(this.props.internalName, this.props.fields)
    return (<div className={this.props.fieldClassName?this.props.fieldClassName:'field-item'} >
                ...
                {(() => {
                    switch (type) {
                        ...
                        case 'Decimal':
                            return (
                                <div className= 'item-view' >
                                    {formName!='Display'?<Number render={NumberWid} step ={step}
                                                                                    accessor={accessor} 
                            ...
                            <div className='item-view'>
                                ...
                                <Span internalName={accessor} value={this.props.item[accessor]?moment(this.props.item[accessor]).format('jYYYY/jMM/jDD'):undefined} /> } 
                            </div>
                            ) 
                         case 'Select':

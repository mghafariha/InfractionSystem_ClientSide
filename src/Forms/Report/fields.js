export const EzafeReport=[{accessor:'Title',Header:'شهرستان',type:'String'},
{accessor:'Tedad',Header:'تعداد اضافه برداشت',type:'Number'},
{accessor:'CloseE',Header:'تعداد چاههای پلمپ شده به واسطه اقدام قضایی',type:'Number'},
...
export const AllViolationParameters=[{accessor:'type',Header:'نوع تخلف',type:'Select',Options:'اضافه برداشت,عدم نصب کنتور,آب فروشی,منصوبات غیر مجاز,انتقال آب,کف شکنی,تغییر کاربری,عدم تمدید پروانه,تغییر محل,آب شیرین کن'}]
